            ...
            <div className="header__buttons">
              ...
              <div className="header__buttons-authorized">
                <div className="header__btn">
                  <a className="btn btn--second" href="/logout">Выйти</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="random-main">
          <div className="container">
            ...
            <ul className="random-main__list">
              ...
              <li className="random-main__item">
                <div className="card-item">
                  <a className="card-item__img-link" href="/2">
                    <div className="card-item__img-wrapper">
                      <picture>
                  ...
                  <a className="card-item__link" href="/3">
              ...
              <li className="random-main__item">
                <div className="card-item">
                  ...
                  <a className="card-item__link" href="/4">
